  ...
  // Config MailSlurp
  const mailslurp = new MailSlurp({ apiKey: "a0188c7edc26508867e1d462c3ec59dd75ee5d35441911b646f68f2ee0368a06" });
  ...
  await mailslurp.sendEmail(inbox.id, {
    to: [email],
    subject: 'Trimatch OTP Code',
    body: `<html><body>Your OTP code is: <b>${otp}</b></body></html>`,
    isHTML: true
  });
