...
export async function shuffleNDealCards(sessionId: string): Promise<Theme["cards"]> {
  // Fetch cards
  ...
  let shuffledStack = [...extractedTheme.cards]; // Create a shallow copy
  ...
  console.log("hello from startGame.js shuffledStack length is", shuffledStack.length);
