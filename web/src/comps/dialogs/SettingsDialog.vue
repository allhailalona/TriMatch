      ...
      <v-card-text>
        ...
        <div class="mb-4 border border-gray-200 rounded">
          ...
          <div v-if="accordion1Open" class="p-3 border-t">
            "Full stack marathon - Stopwatch runs until you complete all 81 cards. Race against yourself and track your best time!"
          </div>
        </div>
        ...
        <div class="border border-gray-200 rounded">
          ...
          <div v-if="accordion2Open" class="p-3 border-t">
            "3-minute speedrun challenge - Complete as much as you can! Your final score is recorded when the timer hits zero."
          </div>
        </div>
        ...
        <div class="mt-5 flex flex-row justify-between items-center">
          <div class="flex items-center">
            <input type="checkbox" v-model="cheatMode" @click="handleChangeCheatMode" class="h-6 w-6 mr-3 hover:cursor-pointer">
            <label for="cheat-mode" class="font-bold text-lg hover:cursor-default">Cheat Mode</label>
          </div>
          <h1 class='hover:cursor-pointer text-xl font-bold text-blue-500 underline'>DISCLAIMER</h1>
        </div>        
      </v-card-text>
    </v-card>
  </v-dialog>
