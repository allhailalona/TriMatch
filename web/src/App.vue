<template>
  ...
  <div v-if="isMobile" class="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg max-w-sm text-center">
      ...
      <p class="mb-6">A responsive mobile web view is NOT supported due to SVG styling limitations in Vue, you are welcome to download the APK file, which for now can be played on tablet sized devices only.</p>
      <div class="space-y-2">
        <a 
